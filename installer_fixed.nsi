...
Section "Main Application" SecMain
    ...
    IfFileExists "deploy\${APP_EXE}" FileFound FileNotFound
    FileNotFound:
        MessageBox MB_OK|MB_ICONSTOP "Error: Application files not found! Please ensure the project has been built correctly."
        Abort
    FileFound:
